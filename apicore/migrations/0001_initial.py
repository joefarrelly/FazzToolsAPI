# Generated by Django 3.2.8 on 2021-11-04 23:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="apicore.dataprofession"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mount",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="apicore.datamount"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reagent",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="apicore.datareagent"
                    ),
                ),
                (
                    "recipe",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="apicore.dataprofessionrecipe",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="tier",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="apicore.dataprofessiontier"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "equipment",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="apicore.dataequipment"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="apicore.profilealtprofession",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("altName", "altRealmSlug"), name="unique_alt"
            ),
        ),
        migrations.AddConstraint(
            model_name="dataequipmentvariant",
            constraint=models.UniqueConstraint(
                fields=("equipment", "variant"), name="unique_equipmentvariant"
            ),
        ),
        migrations.AddConstraint(
            model_name="profilealtprofessiondata",
            constraint=models.UniqueConstraint(
                fields=("alt", "profession", "professionTier", "professionRecipe"),

...
profile.register(r"userpets", views.ProfileUserPetView)
...
profile.register(r"altachievements", views.ProfileAltAchievementView)
...
data.register(r"pets", views.DataPetView)
data.register(r"achievements", views.DataAchievementView)
data.register(r"factions", views.DataFactionView)
data.register(r"mythicdungeons", views.DataMythicDungeonView)
...
custom.register(r"datascan/mythicdungeons", views.DataScanMythicDungeons, "datascanmythicdungeons")
